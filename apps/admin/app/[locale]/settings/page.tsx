...
const SettingsManagement = dynamic(
  () => import("@/components/settings/SettingsManagement").then((mod) => ({ default: mod.SettingsManagement })),
  {
...
const SiteCustomization = dynamic(
  () => import("@/components/settings/SiteCustomization").then((mod) => ({ default: mod.SiteCustomization })),
  {
    loading: () => <PageSkeleton />,
  }
);
...
const StaticPagesEditor = dynamic(
  () => import("@/components/settings/StaticPagesEditor").then((mod) => ({ default: mod.StaticPagesEditor })),
  {
    loading: () => <PageSkeleton />,
  }
);
...
const BackupRestore = dynamic(
  () => import("@/components/settings/BackupRestore").then((mod) => ({ default: mod.BackupRestore })),
  {
    loading: () => <PageSkeleton />,
  }
);
...
const AdvancedConfiguration = dynamic(
  () => import("@/components/settings/AdvancedConfiguration").then((mod) => ({ default: mod.AdvancedConfiguration })),
  {
    loading: () => <PageSkeleton />,
  }
);
