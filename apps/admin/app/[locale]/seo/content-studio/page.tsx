...
const ContentStudioOverview = dynamic(
  () => import("@/components/content-studio/ContentStudioOverview").then((mod) => ({ default: mod.ContentStudioOverview })),
  {
...
const ContentStudioTabs = dynamic(
  () => import("@/components/content-studio/ContentStudioTabs").then((mod) => ({ default: mod.ContentStudioTabs })),
  {
    loading: () => <PageSkeleton />,
  }
);
...
const ContentExportImport = dynamic(
  () => import("@/components/content-studio/ContentExportImport").then((mod) => ({ default: mod.ContentExportImport })),
  {
    loading: () => <PageSkeleton />,
  }
);
...
const ContentSearch = dynamic(
  () => import("@/components/content-studio/ContentSearch").then((mod) => ({ default: mod.ContentSearch })),
  {
    loading: () => <PageSkeleton />,
  }
);
