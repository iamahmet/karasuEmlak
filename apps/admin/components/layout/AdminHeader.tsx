...
export function AdminHeader() {
  ...
  return (
    <header role="banner" className="sticky top-0 z-30 w-full border-b border-white/20 dark:border-[#0a3d35]/50 bg-white/80 dark:bg-muted/80 backdrop-blur-xl supports-[backdrop-filter]:bg-white/70 dark:supports-[backdrop-filter]:bg-muted/70 shadow-xl shadow-black/5 dark:shadow-black/30">
      ...
      <div className="container flex h-14 items-center gap-3 px-4 md:px-6 relative">
        ...
        <div className="flex-1 max-w-sm">
          <div className="relative group">
            ...
            <Search className="absolute left-3 top-1/2 h-4 w-4 -translate-y-1/2 text-muted-foreground group-focus-within:text-primary dark:group-focus-within:text-primary transition-all duration-300 group-focus-within:scale-110 z-10" />
            <Input
              type="search"
              ...
              className="pl-10 pr-16 h-10 text-sm border border-white/30 dark:border-[#0a3d35]/50 focus:border-design-light dark:focus:border-design-light bg-white/60 dark:bg-card/60 backdrop-blur-md text-foreground transition-all duration-300 rounded-xl font-ui placeholder:text-design-gray dark:placeholder:text-gray-400 cursor-pointer hover:border-design-light/60 dark:hover:border-design-light/60 hover:shadow-lg hover:bg-white/80 dark:hover:bg-card/80 input-professional focus-professional relative z-10"
            />
            <span id="search-hint" className="sr-only">Aramak için ⌘K tuşlarına basın</span>
            <kbd className="absolute right-2.5 top-1/2 -translate-y-1/2 px-2 py-1 text-[10px] font-mono bg-gradient-to-br from-[#E7E7E7] to-[#E7E7E7]/80 dark:from-[#062F28] dark:to-[#062F28]/80 border border-border/40/50 dark:border-border/40/50 rounded-lg text-muted-foreground shadow-sm z-10">
              ⌘K
            </kbd>
          </div>
        </div>
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button 
                ...
                aria-haspopup="true"
                className="h-9 w-9 rounded-xl hover:bg-[#E7E7E7]/50 dark:hover:bg-card/50 transition-all duration-300 hover:scale-110 hover:shadow-lg micro-bounce relative group"
              >
                ...
                <div className="flex flex-col space-y-2">
                  <div className="flex items-center gap-3">
                    ...
                    <div className="min-w-0 flex-1">
                      <p className="text-xs font-ui font-bold leading-none text-foreground truncate">
                        {user?.email || "User"}
                      </p>
                      <p className="text-[10px] leading-none text-muted-foreground mt-1.5 font-ui font-medium">
                        Admin
                      </p>
                    </div>
                  </div>
