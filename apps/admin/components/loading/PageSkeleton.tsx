  ...
  return (
    <div className="admin-container responsive-padding space-section">
      ...
      <div className="space-y-2">
        <Skeleton className="h-10 w-64 bg-[#E7E7E7] dark:bg-muted rounded-lg" />
        <Skeleton className="h-4 w-96 bg-[#E7E7E7] dark:bg-muted rounded-lg" />
      </div>
...
export function TableSkeleton({ rows = 5 }: { rows?: number }) {
  return (
    <div className="rounded-lg border border-border/40 dark:border-border/40 bg-white dark:bg-card">
      <div className="p-4">
