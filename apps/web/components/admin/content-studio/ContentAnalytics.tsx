    ...
    <div className="space-y-4">
      ...
      <Card className="card-professional">
        ...
        <CardContent className="px-5 pb-5">
          {trendData.length > 0 ? (
            <div className="h-56 rounded-xl border border-[#E7E7E7] dark:border-[#062F28] bg-gradient-to-br from-[#E7E7E7]/20 to-transparent dark:from-[#062F28]/20 dark:to-transparent p-2">
