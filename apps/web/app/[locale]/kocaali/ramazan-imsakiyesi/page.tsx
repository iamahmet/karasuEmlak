...
export async function generateMetadata({
  ...
  const canonicalPath = `${basePath}/kocaali/ramazan-imsakiyesi`;
  ...
  return {
    title: 'Sakarya Kocaali Ramazan İmsakiyesi 2026 | İftar Vakitleri ve Sahur Saatleri',
    description:
      'Sakarya Kocaali Ramazan imsakiyesi 2026: imsak, iftar vakitleri ve gün gün saatler. Ayrıca Kocaali iftara kaç dakika kaldı geri sayımı.',
    keywords: [
      'sakarya kocaali ramazan imsakiyesi',
      'sakarya kocaali iftar vakitleri',
      'kocaali iftara kaç dakika kaldı',
      'kocaali imsakiye 2026',
      'kocaali iftar saati',
    ],
    alternates: {
      canonical: `${siteConfig.url}${canonicalPath}`,
      languages: pruneHreflangLanguages({
        tr: '/kocaali/ramazan-imsakiyesi',
        en: '/en/kocaali/ramazan-imsakiyesi',
        et: '/et/kocaali/ramazan-imsakiyesi',
        ru: '/ru/kocaali/ramazan-imsakiyesi',
        ar: '/ar/kocaali/ramazan-imsakiyesi',
      }),
    },
    openGraph: {
      title: 'Sakarya Kocaali Ramazan İmsakiyesi 2026',
      description: 'Kocaali için imsak, iftar vakitleri ve gün gün saatler. İftara kaç dakika kaldı geri sayımı.',
      url: `${siteConfig.url}${canonicalPath}`,
      type: 'website',
      images: [{ url: ogImageUrl, width: 1200, height: 630, alt: 'Sakarya Kocaali Ramazan İmsakiyesi 2026' }],
    },
    twitter: {
      card: 'summary_large_image',
      title: 'Sakarya Kocaali Ramazan İmsakiyesi 2026',
      description: 'Kocaali için imsak, iftar vakitleri ve gün gün saatler.',
      images: [ogImageUrl],
    },
...
export default async function KocaaliRamazanImsakiyePage({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
  ...
  const [todayTimes, tomorrowTimes, ramadanRange] = await Promise.all([
    ...
    getPrayerTimesRange({
      districtId: DISTRICT_IDS.KOCAALI,
  ...
  const breadcrumbs = [
    ...
    { label: 'Ramazan İmsakiyesi', href: `${basePath}/kocaali/ramazan-imsakiyesi` },
  ];

  const breadcrumbSchema = generateBreadcrumbSchema([
    { name: 'Ana Sayfa', url: siteConfig.url },
    { name: 'Kocaali', url: `${siteConfig.url}${basePath}/kocaali` },
    { name: 'Ramazan İmsakiyesi', url: `${siteConfig.url}${basePath}/kocaali/ramazan-imsakiyesi` },
  ]);

  const faqSchema = generateFAQSchema([
    {
      question: 'Sakarya Kocaali Ramazan imsakiyesi 2026 nereden bakılır?',
      answer:
        'Bu sayfada Kocaali için imsak, iftar ve diğer vakitleri gün gün listeleyebilirsiniz. Saatler gün içinde değiştiği için güncel tabloyu takip etmek en sağlıklısıdır.',
    },
    {
      question: 'Kocaali ve Karasu iftar vakitleri farkı var mı?',
      answer:
        'Evet, birkaç dakika fark olabilir. Her ilçe kendi merkezine göre hesaplanır. Bu sayfa Kocaali vakitlerini gösterir.',
    },
    {
      question: 'Kocaali iftara kaç dakika kaldı bilgisi nasıl hesaplanır?',
      answer:
        'Bugünün Kocaali iftar saatine göre geri sayım yapılır. İftar geçtiyse, sayfa otomatik olarak yarının iftarına göre geri sayım gösterir.',
    },
  ]);
      ...
      <div className="min-h-screen bg-white dark:bg-gray-900">
        <div className="container mx-auto px-4 sm:px-6 py-6 sm:py-8 lg:py-12 max-w-7xl">
          <header className="rounded-2xl border-2 border-gray-200 dark:border-gray-700 bg-gradient-to-br from-primary/5 via-white to-blue-50/60 dark:from-primary/10 dark:via-gray-900 dark:to-gray-800 p-4 sm:p-6 md:p-10 shadow-sm mb-6 sm:mb-8">
            <div className="flex flex-col sm:flex-row sm:items-center gap-3">
              ...
              <h1 className="text-2xl sm:text-3xl md:text-5xl font-bold text-gray-900 dark:text-white tracking-tight">
                Sakarya Kocaali Ramazan İmsakiyesi 2026
              </h1>
            </div>
            <p className="text-base md:text-lg text-gray-700 dark:text-gray-300 max-w-3xl leading-relaxed mt-4">
              Bu sayfada <strong>Sakarya Kocaali Ramazan imsakiyesi</strong> ve <strong>Kocaali iftar vakitleri</strong> için gün gün tabloyu bulabilirsiniz.
              Ayrıca &quot;<strong>Kocaali iftara kaç dakika kaldı</strong>&quot; sorusu için pratik bir geri sayım da ekledik.
            </p>

            <div className="flex flex-col sm:flex-row sm:flex-wrap gap-2.5 mt-6">
              <Link href={`${basePath}/kocaali/iftara-kac-dakika-kaldi`} className="w-full sm:w-auto">
          ...
          <section className="rounded-2xl border-2 border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 p-4 sm:p-6 md:p-8 shadow-sm">
            <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-gray-900 dark:text-white mb-2">Ramazan 2026 Kocaali İmsakiyesi (Gün Gün)</h2>
            <p className="text-gray-700 dark:text-gray-300 mb-5">
              Ramazan 2026 için Kocaali&apos;de imsak ve iftar saatleri <strong>{formatTurkeyDate(RAMADAN_2026.FROM)}</strong> ile{' '}
            ...
            {ramadanRange.length > 0 ? (
              ...
              <div className="rounded-xl border-2 border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-700/50 p-4 text-gray-700 dark:text-gray-300">
                Ramazan 2026 aralığı için Kocaali verisi bulunamadı. Import: <code className="text-sm">pnpm tsx scripts/import-karasu-prayer-times.ts --apply --year=2026 --district=9805</code>
              </div>
            )}
