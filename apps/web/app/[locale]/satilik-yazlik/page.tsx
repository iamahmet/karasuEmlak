...
export async function generateMetadata({
  ...
  return {
    ...
    description: 'Türkiye\'de satılık yazlik ilanları. 1+1\'den 4+1\'e kadar geniş seçenek. Güncel fiyatlar, mahalle rehberi ve yatırım analizi. Uzman emlak danışmanlığı ile hayalinizdeki yazlığı bulun.',
...
export default async function SatilikYazlikPage({
  ...
  const faqs = await getSatilikYazlikFAQs();
                ...
                <div className="p-6 bg-white rounded-xl border border-gray-200 shadow-sm">
                  ...
                  <div className="space-y-2">
                    ...
                    <Link href={`${basePath}/kiralik-daire`} className="block p-3 rounded-lg hover:bg-gray-50 transition-colors">
                      <div className="font-semibold text-gray-900">Kiralık Yazlık</div>
                      <div className="text-sm text-gray-600">Kiralık yazlik ilanları</div>
                    </Link>
                  </div>
                </div>
