      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: 'Satılık Villa - Emlak İlanları ve Fiyatları',
        },
      ],
...
async function getSatilikVillaFAQs() {
...
export default async function SatilikVillaPage({
  ...
  const faqs = await getSatilikVillaFAQs();

  // Generate schemas
  const articleSchema = {
    ...generateArticleSchema({
      headline: 'Satılık Villa | En Güncel İlanlar ve Fiyatlar 2025',
  ...
  const breadcrumbSchema = generateBreadcrumbSchema(
    [
      ...
      { name: 'Satılık Villa', url: `${siteConfig.url}${basePath}/satilik-villa` },
    ],
    `${siteConfig.url}${basePath}/satilik-villa`
  );
    ...
    <>
      ...
      <Breadcrumbs
        items={[
          ...
          { label: 'Satılık Villa', href: `${basePath}/satilik-villa` },
        ]}
      />
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <div className="lg:col-span-2 space-y-12">
                ...
                <ScrollReveal direction="up" delay={100}>
                  <article>
                    <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
                      Satılık Villa Arayanlar İçin Genel Bakış
                    </h2>
                ...
                <ScrollReveal direction="up" delay={200}>
                  <div>
                    <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
                      Oda Sayısına Göre Satılık Villa Seçenekleri
                    </h2>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      <div className="p-6 bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl border border-blue-200">
                        ...
                        <Link href={`${basePath}/satilik?propertyType=villa&rooms=1`}>
                      ...
                      <div className="p-6 bg-gradient-to-br from-green-50 to-green-100 rounded-xl border border-green-200">
                        ...
                        <Link href={`${basePath}/satilik?propertyType=villa&rooms=2`}>
                      ...
                      <div className="p-6 bg-gradient-to-br from-purple-50 to-purple-100 rounded-xl border border-purple-200">
                        ...
                        <Link href={`${basePath}/satilik?propertyType=villa&rooms=3`}>
                      ...
                      <div className="p-6 bg-gradient-to-br from-amber-50 to-amber-100 rounded-xl border border-amber-200">
                        ...
                        <Link href={`${basePath}/satilik?propertyType=villa&rooms=4`}>
                    ...
                    <div>
                      <div className="flex items-center justify-between mb-6">
                        <h2 className="text-3xl md:text-4xl font-bold text-gray-900">
                          Öne Çıkan Satılık Villa İlanları
                        </h2>
                        <Link href={`${basePath}/satilik?propertyType=villa`}>
                ...
                <ScrollReveal direction="up" delay={400}>
                  <div className="bg-gradient-to-br from-gray-50 to-gray-100 rounded-2xl p-8 border border-gray-200">
                    <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
                      Satılık Villa Fiyat Analizi ve Piyasa Trendleri
                    </h2>
                    <div className="prose prose-lg max-w-none text-gray-700 space-y-4">
                      <p>
              ...
              <aside className="space-y-6">
                ...
                <div className="p-6 bg-white rounded-xl border border-gray-200 shadow-sm">
                  ...
                  <div className="space-y-2">
                    <Link href={`${basePath}/karasu-satilik-villa`} className="block p-3 rounded-lg hover:bg-gray-50 transition-colors">
                      <div className="font-semibold text-gray-900">Karasu Satılık Villa</div>
