...
export async function generateMetadata({
  ...
  return {
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: 'Kiralık Daire - Emlak İlanları ve Fiyatları',
        },
      ],
    ...
    twitter: {
      ...
      title: 'Kiralık Daire | En Güncel İlanlar',
...
export default async function KiralikDairePage({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
  ...
  const faqsResult = await withTimeout(getKiralikDaireFAQs(), 2000, []);
  const faqs = faqsResult || [];

  // Generate schemas
  const articleSchema = {
    ...generateArticleSchema({
      headline: 'Kiralık Daire | En Güncel İlanlar ve Fiyatlar 2025',
  ...
  const breadcrumbSchema = generateBreadcrumbSchema(
    [
      ...
      { name: 'Kiralık Daire', url: `${siteConfig.url}${basePath}/kiralik-daire` },
    ],
    `${siteConfig.url}${basePath}/kiralik-daire`
  );
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <div className="lg:col-span-2 space-y-12">
                ...
                <ScrollReveal direction="up" delay={100}>
                  <article>
                    <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
                      Kiralık Daire Arayanlar İçin Genel Bakış
                    </h2>
                ...
                <ScrollReveal direction="up" delay={200}>
                  <div>
                    <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
                      Oda Sayısına Göre Kiralık Daire Seçenekleri
                    </h2>
                    ...
                    <div>
                      <div className="flex items-center justify-between mb-6">
                        <h2 className="text-3xl md:text-4xl font-bold text-gray-900">
                          Öne Çıkan Kiralık Daire İlanları
                        </h2>
                        <Link href={`${basePath}/kiralik?propertyType=daire`}>
                ...
                <ScrollReveal direction="up" delay={400}>
                  <div className="bg-gradient-to-br from-gray-50 to-gray-100 rounded-2xl p-8 border border-gray-200">
                    <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
                      Kiralık Daire Fiyat Analizi ve Piyasa Trendleri
                    </h2>
                    <div className="prose prose-lg max-w-none text-gray-700 space-y-4">
                      <p>
              ...
              <aside className="space-y-6">
                ...
                <div className="p-6 bg-white rounded-xl border border-gray-200 shadow-sm">
                  ...
                  <div className="space-y-2">
                    <Link href={`${basePath}/karasu-kiralik-daire`} className="block p-3 rounded-lg hover:bg-gray-50 transition-colors">
                      <div className="font-semibold text-gray-900">Karasu Kiralık Daire</div>
