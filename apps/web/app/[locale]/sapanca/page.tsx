...
export async function generateMetadata({
  ...
  try {
    ...
    return {
      title: 'Sapanca Bungalov & Satılık Emlak İlanları',
      description: 'Sapanca\'da bungalov, satılık daire ve günlük kiralık seçenekleri. Güncel emlak fiyatları ve yatırım fırsatları.',
      keywords: [
        'sapanca bungalov',
          ...
          <div className="container mx-auto px-4 py-16">
            <div className="max-w-4xl mx-auto text-center">
              <h2 className="text-4xl font-bold text-gray-900 dark:text-white mb-4">
                Sapanca Bungalov ve Satılık Emlak
              </h2>
