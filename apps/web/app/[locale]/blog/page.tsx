...
export async function generateMetadata({
  ...
  return {
    ...
    description: 'Karasu emlak blog: Emlak alım-satım rehberleri, yatırım analizleri, mahalle rehberleri ve piyasa trendleri. Uzman görüşleri ve güncel içerikler ile...',
    keywords: [
      'karasu emlak blog',
  ...
  try {
    ...
    if (searchQuery) {
      ...
      if (category) {
        ...
        const result = await getArticles(1000, 0); // Fetch more articles for filtering
        ...
        <div className="container mx-auto px-4 py-8 md:py-10 lg:py-12 max-w-7xl">
          ...
          <section className="mb-10 bg-white/70 dark:bg-gray-800/50 backdrop-blur-md rounded-3xl p-6 md:p-8 border border-gray-200/50 dark:border-gray-700/50 shadow-[0_10px_30px_rgba(0,0,0,0.05)] dark:shadow-[0_10px_30px_rgba(0,0,0,0.2)]">
            <div className="flex items-center gap-3 mb-6">
              <div className="p-2.5 bg-gradient-to-br from-primary/20 to-primary/5 dark:from-primary/30 dark:to-primary/10 rounded-xl border border-primary/20">
