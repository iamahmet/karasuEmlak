...
export async function generateMetadata({
  ...
  return {
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: 'Satılık Ev - Emlak İlanları ve Fiyatları',
        },
      ],
    ...
    twitter: {
      ...
      title: 'Satılık Ev | En Güncel İlanlar',
...
async function getSatilikEvFAQs() {
...
export default async function SatilikEvPage({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
  ...
  const faqs = await getSatilikEvFAQs();

  // Generate schemas
  const articleSchema = {
    ...generateArticleSchema({
      headline: 'Satılık Ev | En Güncel İlanlar ve Fiyatlar 2025',
  ...
  const breadcrumbSchema = generateBreadcrumbSchema(
    [
      ...
      { name: 'Satılık Ev', url: `${siteConfig.url}${basePath}/satilik-ev` },
    ],
    `${siteConfig.url}${basePath}/satilik-ev`
  );
  ...
  const itemListSchema = evListings.length > 0
    ? generateItemListSchema(evListings.slice(0, 20), `${siteConfig.url}${basePath}`, {
        name: 'Satılık Ev İlanları',
        description: `Türkiye'de ${evListings.length} adet satılık daire ilanı. Geniş seçenek.`,
      })
    : null;

  // Generate page content for AI checker
  const pageContentInfo = generatePageContentInfo('Satılık Ev', [
    { id: 'genel-bakis', title: 'Satılık Ev Arayanlar İçin Genel Bakış', content: 'Türkiye\'de satılık ev ilanları ve seçenekleri hakkında kapsamlı bilgi.' },
    { id: 'oda-sayisina-gore', title: 'Oda Sayısına Göre Satılık Ev Seçenekleri', content: '1+1, 2+1, 3+1 ve 4+1 oda seçenekleri.' },
    { id: 'fiyat-analizi', title: 'Satılık Ev Fiyat Analizi', content: 'Fiyat trendleri ve piyasa analizi.' },
    { id: 'mahalle-rehberi', title: 'Mahalle Rehberi', content: 'Popüler mahalleler ve özellikleri.' },
    { id: 'yatirim-tavsiyeleri', title: 'Yatırım Tavsiyeleri', content: 'Yatırım amaçlı satılık ev önerileri.' },
  ]);
    ...
    <>
      ...
      <Breadcrumbs
        items={[
          ...
          { label: 'Satılık Ev', href: `${basePath}/satilik-ev` },
        ]}
      />
              ...
              <div className="max-w-4xl mx-auto text-center">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  <Button asChild size="lg" className="bg-white text-gray-900 hover:bg-gray-100">
                    <Link href={`${basePath}/satilik?propertyType=ev`}>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <div className="lg:col-span-2 space-y-12">
                ...
                <ScrollReveal direction="up" delay={100}>
                  <article>
                    <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
                      Satılık Ev Arayanlar İçin Genel Bakış
                    </h2>
                ...
                <ScrollReveal direction="up" delay={200}>
                  <div>
                    <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
                      Oda Sayısına Göre Satılık Ev Seçenekleri
                    </h2>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      <div className="p-6 bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl border border-blue-200">
                        ...
                        <Link href={`${basePath}/satilik?propertyType=ev&rooms=1`}>
                      ...
                      <div className="p-6 bg-gradient-to-br from-green-50 to-green-100 rounded-xl border border-green-200">
                        ...
                        <Link href={`${basePath}/satilik?propertyType=ev&rooms=2`}>
                      ...
                      <div className="p-6 bg-gradient-to-br from-purple-50 to-purple-100 rounded-xl border border-purple-200">
                        ...
                        <Link href={`${basePath}/satilik?propertyType=ev&rooms=3`}>
                      ...
                      <div className="p-6 bg-gradient-to-br from-amber-50 to-amber-100 rounded-xl border border-amber-200">
                        ...
                        <Link href={`${basePath}/satilik?propertyType=ev&rooms=4`}>
                ...
                <ScrollReveal direction="up" delay={400}>
                  <div className="bg-gradient-to-br from-gray-50 to-gray-100 rounded-2xl p-8 border border-gray-200">
                    <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
                      Satılık Ev Fiyat Analizi ve Piyasa Trendleri
                    </h2>
                    <div className="prose prose-lg max-w-none text-gray-700 space-y-4">
                      <p>
              ...
              <aside className="space-y-6">
                ...
                <div className="p-6 bg-white rounded-xl border border-gray-200 shadow-sm">
                  ...
                  <div className="space-y-2">
                    <Link href={`${basePath}/karasu-satilik-ev`} className="block p-3 rounded-lg hover:bg-gray-50 transition-colors">
                      <div className="font-semibold text-gray-900">Karasu Satılık Ev</div>
