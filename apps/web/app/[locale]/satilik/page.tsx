...
export async function generateMetadata({
  ...
  return {
    ...
    description: 'Karasu ve çevresinde satılık emlak ilanları. Denize sıfır konumlarda satılık daire, villa, yazlık ve arsa seçenekleri. 15 yıllık deneyimli emlak...',
    keywords: [
      'karasu satılık',
