...
export async function generateMetadata({
  ...
  const canonicalPath = locale === routing.defaultLocale ? '/satilik-arsa' : `/${locale}/satilik-arsa`;
  
  return {
    title: 'Satılık Arsa | En Güncel İlanlar ve Fiyatlar 2025 | Karasu Emlak',
    description: 'Türkiye\'de satılık arsa ilanları. 1+1\'den 4+1\'e kadar geniş seçenek. Güncel fiyatlar, mahalle rehberi ve yatırım analizi. Uzman emlak danışmanlığı ile hayalinizdeki arsayı bulun.',
    ...
    openGraph: {
      ...
      description: 'Türkiye\'de satılık arsa ilanları. 1+1\'den 4+1\'e kadar geniş seçenek. Güncel fiyatlar ve mahalle rehberi.',
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: 'Satılık Arsa - Emlak İlanları ve Fiyatları',
        },
      ],
    ...
    twitter: {
      ...
      title: 'Satılık Arsa | En Güncel İlanlar',
      description: 'Türkiye\'de satılık arsa ilanları. Geniş seçenek. Güncel fiyatlar ve mahalle rehberi.',
    },
    robots: {
      index: true,
      follow: true,
...
async function getSatilikArsaFAQs() {
  ...
  if (allFAQs.length === 0) {
    allFAQs.push(
      ...
      {
        question: 'Arsa alırken hangi belgeler gereklidir?',
        answer: 'Arsa alırken tapu, yapı ruhsatı, iskan belgesi, vekaletname (varsa), kimlik belgeleri, gelir belgesi (kredi için), vergi levhası ve diğer yasal belgeler gereklidir. Tüm belgelerin güncel ve eksiksiz olması önemlidir.',
      },
      {
      ...
      {
        question: 'Arsa alırken ekspertiz yaptırmak gerekli mi?',
...
export default async function SatilikArsaPage({
  ...
  const arsaListings = allListings.filter(listing => listing.property_type === 'daire');

  // Group by room count
  const byRooms = {
    '1+1': arsaListings.filter(l => l.features?.rooms === 1),
    '2+1': arsaListings.filter(l => l.features?.rooms === 2),
    '3+1': arsaListings.filter(l => l.features?.rooms === 3),
    '4+1': arsaListings.filter(l => l.features?.rooms === 4),
  };

  // Calculate average price
  const prices = arsaListings
  ...
  const articleSchema = {
    ...generateArticleSchema({
      headline: 'Satılık Arsa | En Güncel İlanlar ve Fiyatlar 2025',
      description: 'Türkiye\'de satılık arsa ilanları. 1+1\'den 4+1\'e kadar geniş seçenek. Güncel fiyatlar, mahalle rehberi ve yatırım analizi.',
  ...
  const breadcrumbSchema = generateBreadcrumbSchema(
    [
      ...
      { name: 'Satılık Arsa', url: `${siteConfig.url}${basePath}/satilik-arsa` },
    ],
    `${siteConfig.url}${basePath}/satilik-arsa`
  );
  ...
  const itemListSchema = arsaListings.length > 0
    ? generateItemListSchema(arsaListings.slice(0, 20), `${siteConfig.url}${basePath}`, {
        name: 'Satılık Arsa İlanları',
              ...
              <div className="max-w-4xl mx-auto text-center">
                <div className="inline-block mb-4">
                  <span className="px-4 py-2 rounded-lg text-xs font-semibold bg-white/10 backdrop-blur-sm border border-white/20 text-white">
                    {arsaListings.length}+ Aktif Arsa İlanı
                  </span>
                </div>
          ...
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-4xl mx-auto">
              <div className="text-center">
                <div className="text-2xl font-bold text-primary">{arsaListings.length}</div>
                <div className="text-sm text-gray-600">Aktif Arsa İlanı</div>
              </div>
              <div className="text-center">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <div className="lg:col-span-2 space-y-12">
                ...
                <ScrollReveal direction="up" delay={100}>
                  <article>
                    <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
                      Satılık Arsa Arayanlar İçin Genel Bakış
                    </h2>
                ...
                <ScrollReveal direction="up" delay={200}>
                  <div>
                    <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
                      Oda Sayısına Göre Satılık Arsa Seçenekleri
                    </h2>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      {/* 1+1 */}
                      <div className="p-6 bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl border border-blue-200">
                        <div className="flex items-center justify-between mb-4">
                          <h3 className="text-xl font-bold text-gray-900">1+1 Arsa</h3>
                        ...
                        <Link href={`${basePath}/satilik?propertyType=arsa&rooms=1`}>
                      ...
                      <div className="p-6 bg-gradient-to-br from-green-50 to-green-100 rounded-xl border border-green-200">
                        <div className="flex items-center justify-between mb-4">
                          <h3 className="text-xl font-bold text-gray-900">2+1 Arsa</h3>
                        ...
                        <Link href={`${basePath}/satilik?propertyType=arsa&rooms=2`}>
                      ...
                      <div className="p-6 bg-gradient-to-br from-purple-50 to-purple-100 rounded-xl border border-purple-200">
                        <div className="flex items-center justify-between mb-4">
                          <h3 className="text-xl font-bold text-gray-900">3+1 Arsa</h3>
                        ...
                        <Link href={`${basePath}/satilik?propertyType=arsa&rooms=3`}>
                      ...
                      <div className="p-6 bg-gradient-to-br from-amber-50 to-amber-100 rounded-xl border border-amber-200">
                        <div className="flex items-center justify-between mb-4">
                          <h3 className="text-xl font-bold text-gray-900">4+1 Arsa</h3>
                        ...
                        <Link href={`${basePath}/satilik?propertyType=arsa&rooms=4`}>
                ...
                {/* Featured Listings */}
                {arsaListings.length > 0 && (
                  <ScrollReveal direction="up" delay={300}>
                    <div>
                      <div className="flex items-center justify-between mb-6">
                        <h2 className="text-3xl md:text-4xl font-bold text-gray-900">
                          Öne Çıkan Satılık Arsa İlanları
                        </h2>
                        <Link href={`${basePath}/satilik?propertyType=arsa`}>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        {arsaListings.slice(0, 6).map((listing) => (
                ...
                <ScrollReveal direction="up" delay={400}>
                  <div className="bg-gradient-to-br from-gray-50 to-gray-100 rounded-2xl p-8 border border-gray-200">
                    <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
                      Satılık Arsa Fiyat Analizi ve Piyasa Trendleri
                    </h2>
                    <div className="prose prose-lg max-w-none text-gray-700 space-y-4">
                      <p>
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      <div className="p-6 bg-white rounded-xl border border-gray-200 shadow-sm">
                        ...
                        <p className="text-gray-700 text-sm leading-relaxed">
                          Arsa fiyatı, noter masrafları, tapu harcı, aidat ve diğer giderler toplam maliyeti oluşturur.
                        </p>
                      </div>
              ...
              <aside className="space-y-6">
                ...
                <div className="p-6 bg-gradient-to-br from-primary/10 to-primary/5 rounded-xl border border-primary/20">
                  ...
                  <div className="space-y-3">
                    <div className="flex justify-between">
                      ...
                      <span className="font-bold text-gray-900">{arsaListings.length}</span>
                    </div>
                    <div className="flex justify-between">
                ...
                <div className="p-6 bg-white rounded-xl border border-gray-200 shadow-sm">
                  ...
                  <div className="space-y-2">
                    <Link href={`${basePath}/karasu-satilik-arsa`} className="block p-3 rounded-lg hover:bg-gray-50 transition-colors">
                      <div className="font-semibold text-gray-900">Karasu Satılık Arsa</div>
                    ...
                    <Link href={`${basePath}/kiralik-daire`} className="block p-3 rounded-lg hover:bg-gray-50 transition-colors">
                      <div className="font-semibold text-gray-900">Kiralık Arsa</div>
                      <div className="text-sm text-gray-600">Kiralık arsa ilanları</div>
                    </Link>
                  </div>
                </div>
          ...
          <div className="container mx-auto px-4 max-w-4xl text-center">
            <ScrollReveal direction="up" delay={0}>
              <h2 className="text-3xl md:text-4xl font-bold mb-4">
                Hayalinizdeki Arsayi Bulun
              </h2>
              <p className="text-lg text-white/90 mb-8 max-w-2xl mx-auto">
                Geniş ilan yelpazesi ve uzman danışmanlık hizmeti ile size en uygun arsayı bulmanıza yardımcı oluyoruz.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
