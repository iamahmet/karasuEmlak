...
export async function generateMetadata({
  ...
  const canonicalPath = locale === routing.defaultLocale ? '/listings/new' : `/${locale}/listings/new`;

  return {
    title: 'Yeni İlan Ekle | Karasu Emlak',
    description: 'Karasu Emlak\'a yeni ilan ekleyin. Satılık veya kiralık emlak ilanınızı kolayca yayınlayın.',
    alternates: {
...
export default async function NewListingPage({
  ...
  const breadcrumbs = [
    ...
    { label: 'Yeni İlan', href: `${basePath}/listings/new` },
  ];
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold mb-4">Yeni İlan Ekle</h1>
