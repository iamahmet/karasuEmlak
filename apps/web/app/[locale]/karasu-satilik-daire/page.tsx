...
export async function generateMetadata({
  ...
  return {
    ...
    keywords: [
      ...
      'karasu 3+1 satılık daire',
      'karasu satılık daire fiyatları',
      'karasu emlak daire',
      'sakarya karasu satılık daire',
    ],
    alternates: {
    ...
    openGraph: {
      ...
      description: 'Karasu\'da satılık daire ilanları. Denize sıfır konumlarda 1+1\'den 4+1\'e kadar geniş seçenek. Güncel fiyatlar ve mahalle rehberi.',
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: 'Karasu Satılık Daire - Emlak İlanları ve Fiyatları',
        },
      ],
    ...
    twitter: {
      ...
      title: 'Karasu Satılık Daire | En Güncel İlanlar',
      description: 'Karasu\'da satılık daire ilanları. Denize sıfır konumlarda geniş seçenek. Güncel fiyatlar ve mahalle rehberi.',
    },
    robots: {
      index: true,
      follow: true,
...
async function getKarasuDaireFAQs() {
  ...
  try {
    const aiQuestions = await withTimeout(
      getAIQuestionsForPage('karasu-satilik-daire', 'karasu', 'pillar'),
      2000,
      []
    );
  ...
  return [
    {
      ...
      answer: 'Karasu\'da satılık daire fiyatları konum, metrekare, oda sayısı, bina yaşı ve özelliklere göre değişmektedir. Denize yakın konumlar ve merkez mahalleler genellikle daha yüksek fiyatlara sahiptir. Ortalama fiyat aralığı 800.000 TL ile 2.500.000 TL arasında değişmektedir. 1+1 daireler 800K-1.2M TL, 2+1 daireler 1M-1.8M TL, 3+1 daireler 1.5M-2.5M TL aralığındadır. Güncel fiyat bilgisi için ilanlarımıza göz atabilir veya bizimle iletişime geçebilirsiniz.',
    },
    {
      question: 'Karasu\'da hangi mahallelerde satılık daire bulunuyor?',
      answer: 'Karasu\'da Merkez, Sahil, Yalı Mahallesi, Liman Mahallesi, İnköy, Aziziye, Cumhuriyet ve diğer mahallelerde satılık daire seçenekleri bulunmaktadır. Her mahallenin kendine özgü avantajları vardır. Denize yakın mahalleler (Sahil, Yalı, Liman) yazlık ve yatırım amaçlı tercih edilirken, merkez mahalleler sürekli oturum için idealdir.',
    },
    {
      question: 'Karasu\'da satılık daire alırken nelere dikkat edilmeli?',
      answer: 'Karasu\'da satılık daire alırken konum, fiyat, bina yaşı, yapı durumu, tapu durumu, denize yakınlık, ulaşım imkanları, asansör, otopark, balkon, deniz manzarası gibi özellikler önemlidir. Özellikle yazlık amaçlı alımlarda kış aylarında bakım ve güvenlik konuları göz önünde bulundurulmalıdır. Profesyonel emlak danışmanımız size tüm bu konularda yardımcı olacaktır.',
    },
    {
      question: 'Karasu\'da satılık daire yatırım için uygun mu?',
      answer: 'Evet, Karasu\'da satılık daire yatırım potansiyeli yüksektir. Özellikle denize yakın konumlar, turizm potansiyeli yüksek alanlar ve merkez mahalleler yatırımcıların ilgisini çekmektedir. İstanbul\'a yakınlığı, gelişen altyapısı ve doğal güzellikleri ile uzun vadede değer kazanma potansiyeli yüksektir. Kiralama geliri de düşünüldüğünde, Karasu\'da satılık daire yatırımı mantıklı bir seçenektir.',
    },
    {
      question: 'Karasu\'da kredi ile daire alınabilir mi?',
      answer: 'Evet, Karasu\'da kredi ile daire alınabilir. Banka kredisi ve peşinat seçenekleri hakkında bilgi almak için bizimle iletişime geçebilirsiniz. Kredi kullanımı durumunda gerekli belgeler, kredi başvuru süreci ve onay koşulları hakkında detaylı bilgi verebiliriz. Genellikle daire değerinin %70-80\'i kadar kredi kullanılabilmektedir.',
    },
    {
      question: 'Karasu\'da satılık daire alım-satım süreci nasıl işler?',
      answer: 'Karasu\'da satılık daire alım-satım süreci genellikle şu adımları içerir: İlan inceleme ve görüntüleme, fiyat pazarlığı, sözleşme imzalama, kapora ödeme, tapu işlemleri, kalan ödeme ve teslim. Tüm süreçte emlak danışmanınız size rehberlik edecektir. Ortalama süre 2-4 hafta arasında değişmektedir.',
    },
    {
      question: 'Karasu\'da hangi oda sayılarında satılık daire bulunuyor?',
      answer: 'Karasu\'da 1+1, 2+1, 3+1 ve 4+1 satılık daire seçenekleri bulunmaktadır. En popüler seçenekler 2+1 ve 3+1 dairelerdir. 1+1 daireler genellikle yatırım amaçlı tercih edilirken, 3+1 ve 4+1 daireler aileler için idealdir.',
    },
    {
      question: 'Karasu\'da denize sıfır satılık daire var mı?',
      answer: 'Evet, Karasu\'da denize sıfır veya denize çok yakın konumlarda satılık daire seçenekleri bulunmaktadır. Özellikle Sahil, Yalı Mahallesi ve Liman Mahallesi\'nde denize yakın daireler mevcuttur. Bu daireler genellikle yatırım ve yazlık amaçlı tercih edilmektedir.',
    },
  ];
}

export default async function KarasuSatilikDairePage({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
                        ...
                        <div className="p-6 bg-gradient-to-br from-emerald-50/50 to-green-50/30 rounded-2xl border border-emerald-200/40">
                          ...
                          <ul className="space-y-3">
                            ...
                            <li className="flex items-start gap-3">
                              <CheckCircle2 className="h-5 w-5 text-[#00A862] flex-shrink-0 mt-0.5" />
                              <div>
                                <strong className="text-gray-900 font-semibold">Kiralama geliri</strong> yatırım getirisi yüksek
                              </div>
                            </li>
                          </ul>
                        </div>
                      ...
                      <div className="grid md:grid-cols-2 gap-4 mt-6">
                        {neighborhoods.slice(0, 8).map((neighborhood) => {
                          ...
                          return (
                            <Link
                              key={neighborhood}
                              href={`${basePath}/mahalle/${neighborhoodSlug}?status=satilik&propertyType=daire`}
